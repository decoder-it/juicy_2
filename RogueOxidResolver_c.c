...
/* Standard interface: IObjectExporter, ver. 0.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO IObjectExporter_ProxyInfo;
    ...
    /* [ref][out] */ DWORD *pAuthnHint)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&IObjectExporter_ProxyInfo,
                  0,
                  0,
                  hRpc,
                  pOxid,
...
/* Standard interface: __MIDL_itf_RogueOxidResolver_0000_0002, ver. 0.0,
   GUID={0x00000000,0x0000,0x0000,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}} */
...
static const MIDL_STUB_DESC IObjectExporter_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& IObjectExporter_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO IObjectExporter_ProxyInfo =
    {
